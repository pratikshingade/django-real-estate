...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(
        verbose_name=_("Phone Number"), max_length=30, default="+918055088300"
    )
    ...
    profile_photo = models.ImageField(
        verbose_name="Profile Photo", default=r".\profile_default.png"
    )
    ...
    city = models.CharField(
        verbose_name=_("City"), max_length=180, default="Pune", blank=False, null=False
    )
    ...
    num_reviews = models.IntegerField(
        verbose_name="Number of Reviews", default=0, blank=True, null=True
    )
