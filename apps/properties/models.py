...
class Property(TimeStampedUUIDModel):
    ...
    user = models.ForeignKey(to=User, on_delete=models.DO_NOTHING, related_name='agent_buyer',
    ...
    description = models.CharField(verbose_name=_('Description'), blank=True, max_length=255,
                                   default='Describe the Property Here!!')

    country = CountryField(_('Country'), default='IN', blank_label='(Select Country)')
    city = models.CharField(verbose_name='City', max_length=180, default='Pune')
    postal_code = models.CharField(verbose_name=_('Postal Code'), max_length=100, default='411052')
    street_address = models.CharField(verbose_name=_('Street Address'), max_length=150, default='Karvey Nagar')
    property_number = models.IntegerField(verbose_name=_('Property Number'), validators=[MinValueValidator(1)]
                                          , default=112)
    price = models.DecimalField(verbose_name=_('Property Price'), max_digits=8, decimal_places=2, default=0.0)
    ...
    plot_area = models.DecimalField(verbose_name=_('Plot Area (ft\u00B3)'), max_digits=8, decimal_places=2, default=0.0)
    total_floor = models.IntegerField(verbose_name=_('Number of Floors'), default=0)
