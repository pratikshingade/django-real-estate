# Generated by Django 3.2.7 on 2024-08-04 15:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number',
                 phonenumber_field.modelfields.PhoneNumberField(default='+918055088300', max_length=30, region=None,
                ...
                ('profile_photo',
                 models.ImageField(default='.\\profile_default.png', upload_to='', verbose_name='Profile Photo')),
                ('gender',
                 models.CharField(choices=[('Male', 'Male'), ('Female', 'Female'), ('Other', 'Other')], default='Male',
                                  max_length=20, verbose_name='Gender')),
                ...
                (
                    'num_reviews',
                    models.IntegerField(blank=True, default=0, null=True, verbose_name='Number of Reviews')),
