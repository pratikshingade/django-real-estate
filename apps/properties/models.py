...
class Property(TimeStampedUUIDModel):
    ...
    postal_code = models.CharField(
        verbose_name=_("Postal Code"), max_length=100, default="411052"
    )
    street_address = models.CharField(
        verbose_name=_("Street Address"), max_length=150, default="Karvey Nagar"
    )
    ...
    price = models.DecimalField(
        verbose_name=_("Property Price"), max_digits=8, decimal_places=2, default=0.0
    )
